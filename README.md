...
4. Run the program by using the named output. For example:
```./execute```
5. The contents of the inventory will be saved to, and loaded from, "inventory.dat" in the program folder.
